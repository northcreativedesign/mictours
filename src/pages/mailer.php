...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recipient = "info@visitmetlakatla.com";
    ...
    $response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6Lcf-jwUAAAAAHK3JZwyagwlP1_3LEhJf0z6ufH_&response=".$captcha."&remoteip=".$_SERVER['REMOTE_ADDR']);
